...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-(--card-spacing) leading-relaxed", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center border-t border-border/60 bg-muted/40 p-(--card-spacing)",
        className
      )}
      {...props}
    />
